import Core, { cloneDeep, getRows, getTooltip, getFormatted, getStackMap, isNull, get, set } from '@opentiny/vue-chart-core';
...
var ChartBar = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
ChartBar.install = function(Vue) {
  Vue.component(ChartBar.name, ChartBar);
};

export { ChartBar, ChartBar as default };
