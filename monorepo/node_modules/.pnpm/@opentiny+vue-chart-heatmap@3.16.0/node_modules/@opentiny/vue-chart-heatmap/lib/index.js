import Core, { getMapJSON, HEAT_MAP_COLOR, itemContent, itemPoint, itemLabel, getFormatted } from '@opentiny/vue-chart-core';
...
var getTooltip = function getTooltip2(args) {
  ...
  function formatter(_ref2) {
    var data2 = _ref2.data, color = _ref2.color;
    var xDim = data2[0];
    var yDim = data2[1];
    var value = data2[2];
...
var ChartHeatmap = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
ChartHeatmap.install = function(Vue) {
  Vue.component(ChartHeatmap.name, ChartHeatmap);
};

export { ChartHeatmap, ChartHeatmap as default };
