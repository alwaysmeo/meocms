...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return withDirectives((openBlock(), createElementBlock(
    ...
    [_hoisted_1, createElementVNode(
      "div",
      {
        class: normalizeClass(["tiny-mobile-mini-picker__content", _ctx.state.toggle ? "is-toggle" : ""])
      },
      [createElementVNode("div", _hoisted_2, [renderSlot(_ctx.$slots, "toolbar", {}, function() {
        ...
        [(openBlock(true), createElementBlock(
          Fragment,
          null,
          renderList(_ctx.state.formattedColumns, function(item, index) {
