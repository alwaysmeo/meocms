import Core, { isDefined, getFormatted, itemPoint, itemLabel, itemContent } from '@opentiny/vue-chart-core';
...
var ChartScatter = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
ChartScatter.install = function(Vue) {
  Vue.component(ChartScatter.name, ChartScatter);
};

export { ChartScatter, ChartScatter as default };
