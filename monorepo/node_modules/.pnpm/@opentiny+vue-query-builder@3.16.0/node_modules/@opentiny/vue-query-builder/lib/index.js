import { defineComponent, setup, $prefix, hooks, isVue2, appProperties } from '@opentiny/vue-common';
import { renderless, api } from '@opentiny/vue-renderless/query-builder/vue';
import Button from '@opentiny/vue-button';
import { resolveComponent, openBlock, createBlock, mergeProps, withCtx, createElementBlock, Fragment, renderList, createCommentVNode, resolveDynamicComponent, createVNode, normalizeClass, toHandlers, withDirectives, vModelDynamic, createElementVNode, normalizeStyle, createTextVNode, toDisplayString, normalizeProps, guardReactiveProps, renderSlot } from 'vue';
...
var classLoophandler = function classLoophandler2(data4) {
  if (Array.isArray(data4)) {
    return data4.filter(Boolean).map(function(item) {
      return classLoophandler2(item);
    }).filter(Boolean).join(" ");
  } else if (typeof data4 === "object") {
    var arr = Object.keys(data4).map(function(key) {
      return data4[key] && key;
    });
...
var joinWith = function joinWith2(strArr, joinChar) {
  ...
  return strArr.map(function(str) {
    return ("" + (str != null ? str : "")).replace(new RegExp(joinChar, "g"), "\\" + joinChar);
  }).join(joinChar);
};
...
var defaultValueProcessorByRule = function defaultValueProcessorByRule2(_ref, _temp) {
  ...
  var escapeSingleQuotes = function escapeSingleQuotes2(v) {
    return typeof v !== "string" || !escapeQuotes ? v : v.replace(/'/g, "''");
  };
...
if (cryptoModule) {
  if (typeof cryptoModule.randomUUID === "function") {
    ...
    generateID = function generateID3() {
      ...
      var i = -1;
      return template.replace(re, function(char) {
        i++;
...
var _sfc_main$e = defineComponent({
  ...
  props: ["className", "handleOnChange", "options", "title", "value", "multiple", "listsAsArrays", "disabled", "testID", "bindProps"],
  ...
  methods: {
    isSelected: function isSelected(data4, value2) {
      return Array.isArray(data4) ? data4.includes(value2) : data4 === value2;
    }
  }
});
function _sfc_render$e(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_tiny_select, mergeProps({
    ...
    class: _ctx.className + " query-builder-select",
    ...
    _: 1
    /* STABLE */
  }, 16, ["data-testid", "class", "modelValue", "value", "title", "disabled", "multiple", "onChange"]);
}
...
function _sfc_render$d(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", {
    ...
    "test-i-d": _ctx.TestID.combinators
  }), null, 16, ["test-i-d"]))], 10, _hoisted_1$8);
}
...
var _sfc_main$b = defineComponent({
  ...
  methods: {
    sameTypeOperator: function sameTypeOperator(val) {
      return this.operatorMap[this.lastOperator] === this.operatorMap[val];
    },
    operatorChangeHandler: function operatorChangeHandler() {
      return this.r.generateOnChangeHandler("operator");
    },
    operatorChange: function operatorChange(val) {
...
function _sfc_render$b(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$7, [_ctx.r.schema.enableDragAndDrop ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.controls.dragHandle), {
    key: 0,
    ref: _ctx.r.dragRef,
    "test-i-d": _ctx.TestID.dragHandle,
    level: _ctx.r.path.length,
    path: _ctx.r.path,
    title: _ctx.r.translations.dragHandle.title,
    label: _ctx.r.translations.dragHandle.label,
    "class-name": _ctx.r.classNames.dragHandle,
    disabled: _ctx.r.disabled,
    context: _ctx.r.context,
    validation: _ctx.r.validationResult,
    schema: _ctx.r.schema
  }, null, 8, ["test-i-d", "level", "path", "title", "label", "class-name", "disabled", "context", "validation", "schema"])) : createCommentVNode("v-if", true), (openBlock(), createBlock(resolveDynamicComponent(_ctx.controls.fieldSelector), {
    "test-i-d": _ctx.TestID.fields,
    options: _ctx.r.schema.fields,
    title: _ctx.r.translations.fields.title,
    value: _ctx.r.rule.field,
    operator: _ctx.r.rule.operator,
    "class-name": _ctx.r.classNames.fields,
    "handle-on-change": _ctx.r.generateOnChangeHandler("field"),
    level: _ctx.r.path.length,
    path: _ctx.r.path,
    disabled: _ctx.r.disabled,
    context: _ctx.r.context,
    validation: _ctx.r.validationResult,
    schema: _ctx.r.schema,
    "bind-props": _ctx.r.schema.bindProps && _ctx.r.schema.bindProps.leftSelect || {}
  }, null, 8, ["test-i-d", "options", "title", "value", "operator", "class-name", "handle-on-change", "level", "path", "disabled", "context", "validation", "schema", "bind-props"])), _ctx.r.schema.autoSelectField || _ctx.r.rule.field !== _ctx.r.translations.fields.placeholderName ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.controls.operatorSelector), {
    key: 1,
    "test-i-d": _ctx.TestID.operators,
    field: _ctx.r.rule.field,
    "field-data": _ctx.r.fieldData,
    title: _ctx.r.translations.operators.title,
    options: _ctx.r.operators,
    value: _ctx.r.rule.operator,
    "class-name": _ctx.r.classNames.operators,
    "handle-on-change": _ctx.operatorChange,
    level: _ctx.r.path.length,
    path: _ctx.r.path,
    disabled: _ctx.r.disabled,
    context: _ctx.r.context,
    validation: _ctx.r.validationResult,
    schema: _ctx.r.schema
  }, null, 8, ["test-i-d", "field", "field-data", "title", "options", "value", "class-name", "handle-on-change", "level", "path", "disabled", "context", "validation", "schema"])) : createCommentVNode("v-if", true), (_ctx.r.schema.autoSelectOperator || _ctx.r.rule.operator !== _ctx.r.translations.operators.placeholderName) && !_ctx.r.hideValueControls ? (openBlock(), createElementBlock(
    Fragment,
    {
      key: 2
    },
    [!["null", "notNull"].includes(_ctx.r.rule.operator) && _ctx.r.valueSources.length > 1 ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.controls.valueSourceSelector), {
      key: 0,
      "test-i-d": _ctx.TestID.valueSourceSelector,
      field: _ctx.r.rule.field,
      "field-data": _ctx.r.fieldData,
      ...
      "class-name": _ctx.r.classNames.valueSource,
      "handle-on-change": _ctx.r.generateOnChangeHandler("valueSource"),
      level: _ctx.r.path.length,
      path: _ctx.r.path,
      disabled: _ctx.r.disabled,
      context: _ctx.r.context,
      validation: _ctx.r.validationResult,
      schema: _ctx.r.schema,
      "bind-props": _ctx.r.schema.bindProps && _ctx.r.schema.bindProps.select || {}
    }, null, 8, ["test-i-d", "field", "field-data", "title", "options", "value", "class-name", "handle-on-change", "level", "path", "disabled", "context", "validation", "schema", "bind-props"])) : createCommentVNode("v-if", true), (openBlock(), createBlock(resolveDynamicComponent(_ctx.controls.valueEditor), {
      "test-i-d": _ctx.TestID.valueEditor,
      field: _ctx.r.rule.field,
      "field-data": _ctx.r.fieldData,
      title: _ctx.r.translations.title,
      operator: _ctx.r.rule.operator,
      value: _ctx.r.rule.value,
      "value-source": _ctx.r.rule.valueSource === void 0 || null ? "value" : _ctx.r.rule.valueSource,
      type: _ctx.r.valueEditorType,
      "input-type": _ctx.r.inputType,
      values: _ctx.r.values,
      "lists-as-arrays": _ctx.r.schema.listsAsArrays,
      "parse-numbers": _ctx.r.schema.parseNumbers,
      separator: _ctx.r.valueEditorSeparator,
      "class-name": _ctx.r.classNames.value,
      "handle-on-change": _ctx.r.generateOnChangeHandler("value"),
      level: _ctx.r.path.length,
      path: _ctx.r.path,
      disabled: _ctx.r.disabled,
      context: _ctx.r.context,
      validation: _ctx.r.validationResult,
      schema: _ctx.r.schema
    }, null, 8, ["test-i-d", "field", "field-data", "title", "operator", "value", "value-source", "type", "input-type", "values", "lists-as-arrays", "parse-numbers", "separator", "class-name", "handle-on-change", "level", "path", "disabled", "context", "validation", "schema"]))],
    64
    /* STABLE_FRAGMENT */
    ...
    key: 3,
    "test-i-d": _ctx.TestID.cloneRule,
    label: _ctx.r.translations.cloneRule.label,
    title: _ctx.r.translations.cloneRule.title,
    "class-name": _ctx.r.classNames.cloneRule,
    "handle-on-click": _ctx.r.cloneRule,
    level: _ctx.r.path.length,
    path: _ctx.r.path,
    disabled: _ctx.r.disabled,
    context: _ctx.r.context,
    validation: _ctx.r.validationResult,
    "rule-or-group": _ctx.r.rule,
    schema: _ctx.r.schema
  }, {
    default: withCtx(function() {
      return [_hoisted_2$3];
    ...
    _: 1
    /* STABLE */
  }, 8, ["test-i-d", "label", "title", "class-name", "handle-on-click", "level", "path", "disabled", "context", "validation", "rule-or-group", "schema"])) : createCommentVNode("v-if", true), _ctx.r.schema.showLockButtons ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.controls.lockRuleAction), {
    key: 4,
    "test-i-d": _ctx.TestID.lockRule,
    label: _ctx.r.translations.lockRule.label,
    title: _ctx.r.translations.lockRule.title,
    "class-name": _ctx.r.classNames.lockRule,
    "handle-on-click": _ctx.r.toggleLockRule,
    level: _ctx.r.path.length,
    path: _ctx.r.path,
    disabled: _ctx.r.disabled,
    "disabled-translation": _ctx.r.parentDisabled ? void 0 : _ctx.r.translations.lockRuleDisabled,
    context: _ctx.r.context,
    validation: _ctx.r.validationResult,
    "rule-or-group": _ctx.r.rule,
    schema: _ctx.r.schema
    ...
    _: 1
    /* STABLE */
  }, 8, ["test-i-d", "label", "title", "class-name", "handle-on-click", "level", "path", "disabled", "disabled-translation", "context", "validation", "rule-or-group", "schema"])) : createCommentVNode("v-if", true), _ctx.queryBuilderRoot.showClearBtn ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.controls.clearDataAction), {
    key: 5,
    "test-i-d": _ctx.TestID.clearData,
    label: _ctx.r.translations.clearData.label,
    title: _ctx.r.translations.clearData.title,
    "class-name": _ctx.r.classNames.clearData,
    "handle-on-click": _ctx.r.clearData,
    level: _ctx.r.path.length,
    path: _ctx.r.path,
    disabled: _ctx.r.disabled,
    context: _ctx.r.context,
    ...
    _: 1
    /* STABLE */
  }, 8, ["test-i-d", "label", "title", "class-name", "handle-on-click", "level", "path", "disabled", "context", "validation", "rule-or-group", "schema"])) : (openBlock(), createBlock(resolveDynamicComponent(_ctx.controls.removeRuleAction), {
    key: 6,
    "test-i-d": _ctx.TestID.removeRule,
    label: _ctx.r.translations.removeRule.label,
    title: _ctx.r.translations.removeRule.title,
    "class-name": _ctx.r.classNames.removeRule,
    "handle-on-click": _ctx.r.removeRule,
    level: _ctx.r.path.length,
    path: _ctx.r.path,
    disabled: _ctx.r.disabled,
    context: _ctx.r.context,
    ...
    _: 1
    /* STABLE */
  }, 8, ["test-i-d", "label", "title", "class-name", "handle-on-click", "level", "path", "disabled", "context", "validation", "rule-or-group", "schema"]))]);
}
...
var _hoisted_1$6 = ["data-testid", "data-dragmonitorid", "data-dropmonitorid", "data-rule-id", "data-level", "data-path"];
    ...
    [(openBlock(true), createElementBlock(
      ...
      renderList(_ctx.rg.ruleGroup.rules, function(r3, idx) {
        return openBlock(), createElementBlock("div", {
          ...
          "class-name": _ctx.rg.classNames.combinators,
          "handle-on-change": _ctx.rg.onCombinatorChange,
          ...
          "independent-combinators": _ctx.rg.schema.independentCombinators,
          schema: _ctx.rg.schema
        }, null, 8, ["options", "value", "title", "class-name", "handle-on-change", "rules", "level", "context", "validation", "component", "path", "disabled", "independent-combinators", "schema"])) : createCommentVNode("v-if", true), typeof r3 === "string" ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.controls.inlineCombinator), {
          key: 1,
          options: _ctx.rg.schema.combinators,
          value: r3,
          title: _ctx.rg.translations.combinators.title,
          "class-name": _ctx.rg.classNames.combinators,
          "handle-on-change": function handleOnChange(val) {
          ...
          "independent-combinators": _ctx.rg.schema.independentCombinators,
          schema: _ctx.rg.schema
        }, null, 8, ["options", "value", "title", "class-name", "handle-on-change", "rules", "level", "context", "validation", "component", "path", "disabled", "independent-combinators", "schema"])) : "rules" in r3 ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.controls.ruleGroup), {
          key: 2,
          id: r3.id,
          schema: _ctx.rg.schema,
          ...
          not: !!r3.not,
          disabled: _ctx.getFields[idx].thisPathDisabled,
          "parent-disabled": _ctx.rg.parentDisabled || _ctx.rg.disabled,
          context: _ctx.rg.context
        }, null, 8, ["id", "schema", "actions", "path", "translations", "rule-group", "rules", "combinator", "not", "disabled", "parent-disabled", "context"])) : (openBlock(), createBlock(resolveDynamicComponent(_ctx.controls.rule), {
          key: 3,
          id: r3.id,
          rule: r3,
          field: r3.field,
          ...
          translations: _ctx.rg.translations,
          context: _ctx.rg.context,
          "only-one": _ctx.onlyOne
        }, null, 8, ["id", "rule", "field", "operator", "value", "value-source", "schema", "actions", "path", "disabled", "parent-disabled", "translations", "context", "only-one"]))]);
      }),
      128
      /* KEYED_FRAGMENT */
    ))],
...
var _hoisted_1$5 = ["data-testid", "data-dragmonitorid", "data-dropmonitorid", "data-rule-group-id", "data-level", "data-path"];
var _hoisted_2$2 = {
...
function _sfc_render$8(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    validation: _ctx.rg.validationResult,
    schema: _ctx.rg.schema
  }, null, 8, ["test-i-d", "options", "value", "title", "class-name", "handle-on-change", "rules", "level", "path", "disabled", "context", "validation", "schema"])) : createCommentVNode("v-if", true)]), createElementVNode("div", _hoisted_3$1, [createVNode(
    ...
    [createElementVNode("div", _hoisted_4$1, [_ctx.rg.path.length > 0 && _ctx.rg.schema.enableDragAndDrop ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.controls.dragHandle), {
      ...
      "class-name": _ctx.rg.classNames.dragHandle,
      disabled: _ctx.rg.disabled,
      context: _ctx.rg.context,
      validation: _ctx.rg.validationResult,
      schema: _ctx.rg.schema
    }, null, 8, ["test-i-d", "level", "path", "title", "label", "class-name", "disabled", "context", "validation", "schema"])) : createCommentVNode("v-if", true), _ctx.rg.schema.showNotToggle ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.controls.notToggle), {
      key: 1,
      "test-i-d": _ctx.TestID.notToggle,
      "class-name": _ctx.rg.classNames.notToggle,
      title: _ctx.rg.translations.notToggle.title,
      label: _ctx.rg.translations.notToggle.label,
      checked: _ctx.rg.ruleGroup.not,
      "handle-on-change": _ctx.rg.onNotToggleChange,
      level: _ctx.rg.path.length,
      disabled: _ctx.rg.disabled,
      path: _ctx.rg.path,
      context: _ctx.rg.context,
      validation: _ctx.rg.validationResult,
      schema: _ctx.rg.schema
    }, null, 8, ["test-i-d", "class-name", "title", "label", "checked", "handle-on-change", "level", "disabled", "path", "context", "validation", "schema"])) : createCommentVNode("v-if", true), (openBlock(), createBlock(resolveDynamicComponent(_ctx.controls.addRuleAction), {
      "test-i-d": _ctx.TestID.addRule,
      label: _ctx.rg.translations.addRule.label,
      title: _ctx.rg.translations.addRule.title,
      "class-name": _ctx.rg.classNames.addRule,
      "handle-on-click": _ctx.rg.addRule,
      rules: _ctx.rg.ruleGroup.rules,
      level: _ctx.rg.path.length,
      path: _ctx.rg.path,
      disabled: _ctx.rg.disabled,
      context: _ctx.rg.context,
      validation: _ctx.rg.validationResult,
      "rule-or-group": _ctx.rg.ruleGroup,
      schema: _ctx.rg.schema
    }, {
      default: withCtx(function() {
        return [createVNode(_component_IconPlus, {
          ...
          " " + toDisplayString(_ctx.$t("ui.queryBuilder.addItem")),
          1
          /* TEXT */
        )];
      }),
      _: 1
      /* STABLE */
    }, 8, ["test-i-d", "label", "title", "class-name", "handle-on-click", "rules", "level", "path", "disabled", "context", "validation", "rule-or-group", "schema"])), (openBlock(), createBlock(resolveDynamicComponent(_ctx.controls.addGroupAction), {
      "test-i-d": _ctx.TestID.addGroup,
      label: _ctx.rg.translations.addGroup.label,
      title: _ctx.rg.translations.addGroup.title,
      "class-name": _ctx.rg.classNames.addGroup,
      "handle-on-click": _ctx.rg.addGroup,
      rules: _ctx.rg.ruleGroup.rules,
      level: _ctx.rg.path.length,
      path: _ctx.rg.path,
      disabled: _ctx.rg.disabled,
      ...
      default: withCtx(function() {
        return [createVNode(_component_IconPlus, {
          ...
          " " + toDisplayString(_ctx.$t("ui.queryBuilder.addGroup")),
          1
          /* TEXT */
        )];
      }),
      _: 1
      /* STABLE */
    }, 8, ["test-i-d", "label", "title", "class-name", "handle-on-click", "rules", "level", "path", "disabled", "context", "validation", "rule-or-group", "schema"])), _ctx.rg.path.length >= 1 ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.controls.removeGroupAction), {
      key: 2,
      "test-i-d": _ctx.TestID.removeGroup,
      label: _ctx.rg.translations.removeGroup.label,
      title: _ctx.rg.translations.removeGroup.title,
      "class-name": _ctx.rg.classNames.removeGroup,
      "handle-on-click": _ctx.rg.removeGroup,
      rules: _ctx.rg.ruleGroup.rules,
      level: _ctx.rg.path.length,
      path: _ctx.rg.path,
      disabled: _ctx.rg.disabled,
      ...
      default: withCtx(function() {
        return [createVNode(_component_IconDel, {
          ...
          " " + toDisplayString(_ctx.$t("ui.queryBuilder.removeGroup")),
          1
          /* TEXT */
        )];
      }),
      _: 1
      /* STABLE */
    }, 8, ["test-i-d", "label", "title", "class-name", "handle-on-click", "rules", "level", "path", "disabled", "context", "validation", "rule-or-group", "schema"])) : createCommentVNode("v-if", true), _ctx.rg.schema.showCloneButtons && _ctx.rg.path.length >= 1 ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.controls.cloneGroupAction), {
      key: 3,
      "test-i-d": _ctx.TestID.cloneGroup,
      label: _ctx.rg.translations.cloneRuleGroup.label,
      title: _ctx.rg.translations.cloneRuleGroup.title,
      "class-name": _ctx.rg.classNames.cloneGroup,
      "handle-on-click": _ctx.rg.cloneGroup,
      rules: _ctx.rg.ruleGroup.rules,
      level: _ctx.rg.path.length,
      path: _ctx.rg.path,
      disabled: _ctx.rg.disabled,
      ...
      _: 1
      /* STABLE */
    }, 8, ["test-i-d", "label", "title", "class-name", "handle-on-click", "rules", "level", "path", "disabled", "context", "validation", "rule-or-group", "schema"])) : createCommentVNode("v-if", true), _ctx.rg.schema.showLockButtons ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.controls.lockGroupAction), {
      key: 4,
      "test-i-d": _ctx.TestID.lockGroup,
      label: _ctx.rg.translations.lockGroup.label,
      title: _ctx.rg.translations.lockGroup.title,
      "class-name": _ctx.rg.classNames.lockGroup,
      "handle-on-click": _ctx.rg.toggleLockGroup,
      rules: _ctx.rg.ruleGroup.rules,
      level: _ctx.rg.path.length,
      path: _ctx.rg.path,
      disabled: _ctx.rg.disabled,
      "disabled-translation": _ctx.rg.parentDisabled ? void 0 : _ctx.rg.translations.lockGroupDisabled,
      context: _ctx.rg.context,
      validation: _ctx.rg.validationResult,
      "rule-or-group": _ctx.rg.ruleGroup,
      schema: _ctx.rg.schema
    }, null, 8, ["test-i-d", "label", "title", "class-name", "handle-on-click", "rules", "level", "path", "disabled", "disabled-translation", "context", "validation", "rule-or-group", "schema"])) : createCommentVNode("v-if", true)])],
    2
    /* CLASS */
  )]), _hoisted_6], 10, _hoisted_1$5);
}
...
var _sfc_main$6 = defineComponent({
  ...
  computed: {
    inputProps: function inputProps() {
      var _this$schema$bindProp;
      var inputProp = ((_this$schema$bindProp = this.schema.bindProps) == null ? void 0 : _this$schema$bindProp.input) || {};
      return _extends({}, this.props, inputProp);
    },
    numericProps: function numericProps() {
      var _this$schema$bindProp2;
      var numericProp = ((_this$schema$bindProp2 = this.schema.bindProps) == null ? void 0 : _this$schema$bindProp2.numeric) || {};
      return _extends({}, this.props, numericProp);
    },
    dateProps: function dateProps() {
      var _this$schema$bindProp3;
      var dateProp = ((_this$schema$bindProp3 = this.schema.bindProps) == null ? void 0 : _this$schema$bindProp3.date) || {};
      return _extends({}, this.props, dateProp);
    },
    timeProps: function timeProps() {
      var _this$schema$bindProp4;
      var timeProp = ((_this$schema$bindProp4 = this.schema.bindProps) == null ? void 0 : _this$schema$bindProp4.time) || {};
      return _extends({}, this.props, timeProp);
    },
    radioProps: function radioProps() {
      var _this$schema$bindProp5;
      var radioProp = ((_this$schema$bindProp5 = this.schema.bindProps) == null ? void 0 : _this$schema$bindProp5.radio) || {};
      return _extends({}, this.props, radioProp);
    },
    checkboxProps: function checkboxProps() {
      var _this$schema$bindProp6;
      var checkboxProp = ((_this$schema$bindProp6 = this.schema.bindProps) == null ? void 0 : _this$schema$bindProp6.checkbox) || {};
      return _extends({}, this.props, checkboxProp);
    }
  },
  data: function data2() {
    return {
...
function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _ctx.inputProps, toHandlers(_ctx.events), {
  ...
  }, _ctx.numericProps, toHandlers(_ctx.events), {
    "onUpdate:modelValue": _ctx.update
  ...
  }, _ctx.dateProps, toHandlers(_ctx.events), {
    "onUpdate:modelValue": _ctx.update
  ...
  }, _ctx.timeProps, toHandlers(_ctx.events), {
    "onUpdate:modelValue": _ctx.update
  ...
  }, _ctx.radioProps, toHandlers(_ctx.events), {
    "onUpdate:modelValue": _ctx.update
  ...
  }, _ctx.checkboxProps, toHandlers(_ctx.events), {
    "onUpdate:modelValue": _ctx.update
  ...
  }, _ctx.inputProps, toHandlers(_ctx.events, true), {
    onInput: _cache[7] || (_cache[7] = function() {
      return _ctx.update && _ctx.update.apply(_ctx, arguments);
    })
  }), null, 16, _hoisted_1$4)), [[vModelDynamic, _ctx.modelValue]]);
}
...
function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return !_ctx.show ? (openBlock(), createElementBlock("div", _hoisted_1$3)) : ["text", "select"].includes(_ctx.type) && ["between", "notBetween"].includes(_ctx.operator) ? (openBlock(), createElementBlock("span", {
    key: 1,
    "data-testid": _ctx.testID,
    ...
    renderList(["from", "to"], function(key, i) {
      ...
      }, null, 8, ["type", "value", "schema", "props", "events"])) : (openBlock(), createBlock(resolveDynamicComponent(_ctx.allProps.SelectorComponent), mergeProps({
        key
      }, _ctx.otherProps, {
        class: _ctx.standardClassnames.valueListItem,
        disabled: _ctx.disabled,
        "bind-props": _ctx.schema.bindProps && _ctx.schema.bindProps.select || {}
      }), null, 16, ["class", "disabled", "bind-props"])), i === 0 ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.separator), {
        key: 2
      })) : createCommentVNode("v-if", true)]);
    }),
    64
    ...
    "test-i-d": _ctx.testID,
    "class-name": _ctx.className,
    title: _ctx.title,
    "handle-on-change": _ctx.handleOnChange,
    disabled: _ctx.disabled,
    value: _ctx.value,
    options: _ctx.values,
    multiple: _ctx.type === "multiselect",
    "lists-as-arrays": _ctx.listsAsArrays,
    "bind-props": _ctx.schema.bindProps && _ctx.schema.bindProps.select || {}
  }), null, 16, ["test-i-d", "class-name", "title", "handle-on-change", "disabled", "value", "options", "multiple", "lists-as-arrays", "bind-props"])) : _ctx.type === "radio" ? (openBlock(), createElementBlock("span", {
    key: 3,
    "data-testid": _ctx.testID,
    ...
    renderList(_ctx.values, function(v, key) {
      ...
      }, null, 8, ["type", "value", "schema", "props", "events"]);
    }),
    128
    /* KEYED_FRAGMENT */
...
var _sfc_main$4 = defineComponent({
  ...
  props: ["className", "handleOnChange", "options", "title", "value", "multiple", "listsAsArrays", "disabled", "testID", "schema", "bindProps"],
  ...
  computed: {
    ...
    treeOp: function treeOp() {
      var data4 = this.formatField(this.options);
      return {
        nodeKey: "name",
        data: data4
      };
  ...
  methods: {
    ...
    isSelected: function isSelected2(data4, value2) {
      return Array.isArray(data4) ? data4.includes(value2) : data4 === value2;
    }
  }
});
function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_tiny_select, mergeProps({
    ...
    onChange: _ctx.selectElementChangeHandler,
    "hover-expand": ""
  }), null, 16, ["data-testid", "class", "modelValue", "tree-op", "title", "disabled", "multiple", "onChange"]);
}
...
function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$2, [_hoisted_2, createElementVNode(
    "div",
    {
...
var _hoisted_1$1 = ["data-testid", "title"];
...
var useMergedContext = function useMergedContext2(props) {
  ...
  rqbContext.controlClassnames; rqbContext.controlElements; rqbContext.debugMode; rqbContext.enableDragAndDrop; rqbContext.enableMountQueryChange; rqbContext.translations; var otherContext = _objectWithoutPropertiesLoose(rqbContext, _excluded2);
  return _extends({
    controlClassnames,
    controlElements,
    debugMode,
...
var useRuleGroup = function useRuleGroup2(props) {
  ...
  var classNamesProp = schema.classNames, combinators = schema.combinators, createRule = schema.createRule, createRuleGroup = schema.createRuleGroup, independentCombinators = schema.independentCombinators, validationMap = schema.validationMap, _schema$getRuleGroupC = schema.getRuleGroupClassname, getRuleGroupClassname = _schema$getRuleGroupC === void 0 ? function() {
    return "";
...
var _hoisted_1 = ["data-dnd", "data-inlinecombinators"];
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", {
    ...
    "parent-disabled": _ctx.qb.queryDisabled,
    context: _ctx.qb.context
  }, null, 8, ["translations", "rule-group", "rules", "combinator", "not", "schema", "actions", "id", "disabled", "parent-disabled", "context"]))], 10, _hoisted_1)]);
}
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(
    ...
    [createVNode(_component_query_builder, mergeProps({
      key: "queryIC"
    }, _ctx.config, {
      "independent-combinators": "",
      query: _ctx.query,
      validator: _ctx.validator,
      "on-query-change": _ctx.onQueryChange
