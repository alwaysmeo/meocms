...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("label", mergeProps({
    ...
    "span",
    {
      key: 0,
      ref: "label",
      class: normalizeClass(_ctx.m("py-0 pl-0 sm:pl-2 mr-5 flex-auto leading-7 sm:leading-none", _ctx.state.isDisabled ? "cursor-not-allowed text-color-text-secondary" : "text-color-text-primary", _ctx.state.isDisplayOnly || _ctx.state.isGroupDisplayOnly ? "p-0 sm:p-0 m-0 text-color-text-primary cursor-default" : ""))
    },
